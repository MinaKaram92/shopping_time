...
import 'package:shopping_time/features/home_feature/presentation/views/widgets/category_item.dart';
    ...
    return SizedBox(
      ...
      child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            var categoryItem =
                BlocProvider.of<AppLayoutCubit>(context).categories[index];
          ...
          itemCount:
              BlocProvider.of<AppLayoutCubit>(context).categories.length),
    );
  }
}
